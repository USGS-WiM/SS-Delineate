...
FDR = 'C:/NYBackup/GitHub/ss-delineate/data/nhdplus/NHDPlusMA/NHDPlus02/NHDPlusFdrFac02b/fdr'
#FDR = 'C:/NYBackup/GitHub/ss-delineate/data/ny/archydro/02020001/fdr'
...
def cut_by_geojson(input_file, output_file, shapefile):
    ...
    feature = VectorDataset.GetLayer()[0]
    wkt_geom = feature.GetGeometryRef() 
    min_x, max_x, min_y, max_y = wkt_geom.GetEnvelope()

    print('bounds1:', min_x, max_x, min_y, max_y)
    ...
    wkt_geom.Transform(new_transform)

    print('bounds:', wkt_geom.GetEnvelope())
    ...
    outds = driver.Create(output_file, new_cols, new_rows, bands, gdal.GDT_Float32)
...
feature = dataSource.GetLayer()[0]
geom = feature.GetGeometryRef()

cut_by_geojson(FDR, 'C:/NYBackup/GitHub/ss-delineate/data/fdr.tif', shapefile)